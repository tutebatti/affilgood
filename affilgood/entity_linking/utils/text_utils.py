...
def get_stopwords(language='u') -> set:
    ...
    stopwords['de'] = ['von', 'zu', 'in', 'auf', 'unter', 'über', 'nach', 'mit', 'für', 'der', 'die', 'das', 'des',
                       'dem', 'den', 'ein', 'eine', 'eines', 'einer']
    stopwords['it'] = ['di', 'a', 'da', 'in', 'su', 'con', 'per', 'il', 'lo', 'la', 'l\'', 'i', 'gli', 'le', 'l\'',
                       'un', 'uno', 'una']
    stopwords['fr'] = ['de', 'à', 'dans', 'pour', 'sur', 'sous', 'avec', 'le', 'la', 'les', 'l\'', 'du', 'de la', 'des',
                       'un', 'une', 'des']
